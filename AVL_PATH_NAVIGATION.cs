...
// AVL DATA STRUCTURE IMPLEMENTATION FOR PATH NAVIGATION
...
namespace PathFinder_AVL
{
    ...
    class Node
    {
        ...
        public int Value { get; set; }    // stores values 0 or 1
    ...
    class AVL_BST
    {
        ...
        public void AVL_Insert(Node t, int newVal, string sensor) //O(log(n))
        {
        ...
        public void Initialize(int SenvalRoot, string SenDirRoot, int SenvalLC , string SenDirLC, int SenvalRC, string SenDirRC)  // O(1) initialize with sensor in moving direction
        {
        ...
        public void RootUpdate(int Trigger, string Dir) //O(1)
        {
        ...
        public void UpdatedSensorAdd(int senval, string sensor) // Plan B
        {
        ...
        public void ClockSingleRot() // O(1)
        {
